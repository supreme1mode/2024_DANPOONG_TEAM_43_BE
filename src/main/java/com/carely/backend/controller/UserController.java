...
public class UserController implements UserAPI {
    ...
    public ResponseEntity<ResponseDTO> registerUser(@RequestPart("registerDTO") RegisterDTO registerDTO,  @RequestPart(value = "file", required = false) MultipartFile file) throws IOException {        RegisterDTO.Res res = userService.register(registerDTO, file);

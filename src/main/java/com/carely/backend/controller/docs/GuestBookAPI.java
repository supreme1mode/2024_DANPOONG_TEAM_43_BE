...
public interface GuestBookAPI {
    ...
    public ResponseEntity<?> registerGuestBook(@AuthenticationPrincipal CustomUserDetails user, @RequestBody RequestGuestBookDTO requestGuestBookDTO, @PathVariable Long id);
